...
def supervisor_node(state: AgentState) -> AgentState:
    ...
    route_reason = "default route: factual retrieval"
    needs_tool = False
    risk_high = False

    # Routing keyword rules theo domain IT helpdesk:
    policy_keywords = [
        "hoàn tiền", "refund", "flash sale", "license", "license key", "subscription",
        "cấp quyền", "access level", "access", "level 3", "emergency",
    ]
    retrieval_keywords = ["p1", "escalation", "sla", "ticket", "incident"]
    risk_keywords = ["emergency", "khẩn cấp", "2am", "không rõ", "mơ hồ", "err-"]
